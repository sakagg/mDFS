...
public final class Hdfs {
  ...
  public interface ReportIPRequestOrBuilder extends
      // @@protoc_insertion_point(interface_extends:ReportIPRequest)
      com.google.protobuf.MessageOrBuilder {
  ...
  /**
   * Protobuf type {@code ReportIPRequest}
   */
  public  static final class ReportIPRequest extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:ReportIPRequest)
      ReportIPRequestOrBuilder {
    // Use ReportIPRequest.newBuilder() to construct.
    private ReportIPRequest(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private ReportIPRequest() {
      id_ = 0;
      ip_ = "";
      port_ = 0;
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Hdfs.internal_static_ReportIPRequest_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Hdfs.internal_static_ReportIPRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Hdfs.ReportIPRequest.class, Hdfs.ReportIPRequest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Hdfs.ReportIPRequest)) {
        return super.equals(obj);
      }
      Hdfs.ReportIPRequest other = (Hdfs.ReportIPRequest) obj;
    ...
    public static Hdfs.ReportIPRequest parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Hdfs.ReportIPRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Hdfs.ReportIPRequest parseFrom(
    ...
    public static Hdfs.ReportIPRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Hdfs.ReportIPRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Hdfs.ReportIPRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Hdfs.ReportIPRequest prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:ReportIPRequest)
        Hdfs.ReportIPRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Hdfs.internal_static_ReportIPRequest_descriptor;
      }
      ...
      // Construct using Hdfs.ReportIPRequest.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Hdfs.ReportIPRequest getDefaultInstanceForType() {
        return Hdfs.ReportIPRequest.getDefaultInstance();
      }

      public Hdfs.ReportIPRequest build() {
        Hdfs.ReportIPRequest result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Hdfs.ReportIPRequest buildPartial() {
        Hdfs.ReportIPRequest result = new Hdfs.ReportIPRequest(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Hdfs.ReportIPRequest) {
          return mergeFrom((Hdfs.ReportIPRequest)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Hdfs.ReportIPRequest other) {
        if (other == Hdfs.ReportIPRequest.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
        if (other.hasIp()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Hdfs.ReportIPRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Hdfs.ReportIPRequest) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000002;
      ...
      // @@protoc_insertion_point(builder_scope:ReportIPRequest)
    }

    // @@protoc_insertion_point(class_scope:ReportIPRequest)
    private static final Hdfs.ReportIPRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Hdfs.ReportIPRequest();
    }

    public static Hdfs.ReportIPRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @java.lang.Deprecated public static final com.google.protobuf.Parser<ReportIPRequest>
        PARSER = new com.google.protobuf.AbstractParser<ReportIPRequest>() {
      public ReportIPRequest parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
          return new ReportIPRequest(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<ReportIPRequest> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<ReportIPRequest> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_ReportIPRequest_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_ReportIPRequest_fieldAccessorTable;
  ...
  static {
    ...
    internal_static_ReportIPRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReportIPRequest_descriptor,
